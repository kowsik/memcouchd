...
this.create = function() {
    ...
    return {
        ...
        dbPutDoc: function(name, docid, doc) {
            ...
            } else if (Collate.type(doc) !== Collate._Object) {
                return { error: 'bad_request', reason: 'Document must be a JSON object' };
            }
        ...
        dbGetDocs: function(name, obj, cb) {
            if (Collate.type(obj) !== Collate._Object) {
                return { error: 'bad_request', reason: 'Request body must be a JSON object' };
            }
